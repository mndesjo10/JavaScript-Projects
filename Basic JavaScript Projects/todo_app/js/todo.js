...
function get_todos() {
    /*This creates an array of task that are input*/
    var todos = new Array;
    /*this pulls the task that ws saved in the web browser memory*/
    var todos_str = localStorage.getItem('todo');
    /*If the inout is not null then JSON.parse will communicate with the web browser to make the task a JavaScript object.*/
    if (todos_str !== null) {
